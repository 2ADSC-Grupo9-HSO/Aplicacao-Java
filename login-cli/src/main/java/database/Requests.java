...
public class Requests {
    ...
    public Maquina loginSQL(JdbcTemplate conexao, String user, String password) throws IOException {
        ...
        try {
            ...
            new Log("uso", "Logando com sucesso!!!");
            return maquina;

        } catch (Exception ex) {

            System.out.println("Não foi possivel selecionar os dados " + ex);
            new Log("erro", "Não foi possivel selecionar os dados " + ex);

            return null;
        }
    }

    public void insertSQL(JdbcTemplate conexao, Integer fkMaquina, Double registro) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Não foi possivel Inserir os dados do componente " + ex);
            System.out.println("Ocorreu um problema ao inserir dados " + ex);

        }
    }

    public void insertMaquinaDocker(JdbcTemplate conexao, String hostName, String senhaMaquina, String sistemaOperacional) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Erro ao inserir dados no docker " + ex);

        }
    }

    public MaquinaComProblema selectMaquinaDanificada(JdbcTemplate conexao, Maquina maquina) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Erro ao buscar problema " + ex);
            return null;
        }
    }

    public void selectProcessos(JdbcTemplate conexao, Maquina maquina) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Não foi possivel retornar os dados da lista " + ex);
        }
    }

    public void insertProcessos(JdbcTemplate conexao, Processo processo, Integer fkMaquina) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Erro ao inserir dados dos processos " + ex);

        }
    }

    public void atualizarProcessos(JdbcTemplate conexao, Processo processo, Integer id) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Erro ao atualizar dados dos processos " + ex);
        }
    }

    public Map<String, Object> selectChaveMaquina(JdbcTemplate conexao, Integer idMaquina) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Não foi possivel retornar os dados da chave " + ex);
            return null;
        }
    }

    public void atualizarChaveMaquina(JdbcTemplate conexao, Integer idMaquina) throws IOException {
        ...
        try {
            ...
            new Log("erro", "Erro ao atualizar chaveAtivacao" + ex);
